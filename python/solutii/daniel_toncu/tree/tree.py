...
def print_tree(dirpath, indentation):
	...
	"""Parcurge directorul ce se gaseste la path-ul dirpath si afiseaza numele tuturor instantelor din el. Toate directoarele ce se gasesc in directorul curent, sunt parcurse recursiv."""
	"""Note: Fisierele sunt precedate de [F], Directoarele sunt precedate de [D], si intrarile necunoscute sunt precedate de [U]."""
